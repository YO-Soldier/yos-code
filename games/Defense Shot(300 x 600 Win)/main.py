...
class Shield(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(Shield_img, (70, 70))
        self.rect = self.image.get_rect()
        self.rect.x = random.randrange(80, 220)
...
class Army(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(army_img, (70, 70))
        self.rect = self.image.get_rect()
        self.rect.centerx = WIDTH / 2
        self.rect.bottom = HEIGHT - 20
        self.speed_x = 0
...
class Rifle(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(Rifle_img, (70, 70))
        self.rect = self.image.get_rect()
        self.rect.x = random.randrange(80, 220)
        self.rect.y = random.randrange(240, 260)
        self.speed_y = 1
...
class Mg(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(mg_img, (70, 70))
        self.rect = self.image.get_rect()
        self.rect.x = random.randrange(80, 220)
        self.rect.y = random.randrange(240, 260)
        self.speed_y = 1.25
...
def main():
    ...
    while running:
        ...
        if game_clear:
            ...
            draw_text(screen, "GAME CLEAR", 50, WIDTH//2 - 120, 200, (255, 255, 0))  # 黄色
            pygame.display.flip()
        ...
        # 経過時間
        draw_text(screen, f"Score: {score}", 17, 10, 10)
